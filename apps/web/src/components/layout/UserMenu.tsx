    ...
    <div className="relative" ref={rootRef}>
      ...
      {open ? (
        <div className="absolute right-0 top-[calc(100%+0.5rem)] z-50 w-56 overflow-hidden rounded-lg border border-slate-200 bg-white p-1.5 shadow-xl" role="menu">
          ...
          <Link className="flex min-h-10 items-center gap-2 rounded-md px-3 text-sm font-medium text-slate-700 hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-200" onClick={() => setOpen(false)} role="menuitem" to="/security"><Icon className="size-4" name="settings" /> Sécurité</Link>
          <Link className="flex min-h-10 items-center gap-2 rounded-md px-3 text-sm font-medium text-slate-700 hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-200" onClick={() => setOpen(false)} role="menuitem" to="/neighborhood"><Icon className="size-4" name="map-pin" /> Mon quartier</Link>
          <Link className="flex min-h-10 items-center gap-2 rounded-md px-3 text-sm font-medium text-slate-700 hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-200" onClick={() => setOpen(false)} role="menuitem" to="/documents"><Icon className="size-4" name="contract" /> Mes documents</Link>
