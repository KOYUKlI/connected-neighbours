...
export function AdminShell({
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-600">
      <div className="grid min-h-screen grid-cols-[248px_minmax(0,1fr)] max-[1100px]:grid-cols-1">
        {sidebar}
        <div className="flex min-w-0 flex-col">
          {topbar}
          <PageContainer>{children}</PageContainer>
          <footer className="border-t border-slate-200 px-8 py-3 text-xs font-medium text-slate-400 max-[760px]:px-4">
